...
ActiveSheet.Shapes("Oval 139").Fill.ForeColor.RGB = vbBlue
 Sheets("X").Select
ElseIf Cells(24, j).Value = "SÝVAS" Then
Sheets("Rotalama").Select
...
ActiveSheet.Shapes("Oval 143").Fill.ForeColor.RGB = vbBlue
 Sheets("X").Select
ElseIf Cells(24, j).Value = "ÞANLIURFA" Then
Sheets("Rotalama").Select
...
ActiveSheet.Shapes("Oval 142").Fill.ForeColor.RGB = vbBlue
 Sheets("X").Select
ElseIf Cells(24, j).Value = "ÇANAKKALE" Then
Sheets("Rotalama").Select
ActiveSheet.Shapes("Oval 128").Fill.ForeColor.RGB = vbBlue
 Sheets("X").Select
ElseIf Cells(24, j).Value = "KAYSERÝ" Then
Sheets("Rotalama").Select
...
MsgBox "2. Daðýtým Merkezi {ANKARA} açýlmamýþtýr ve rotasý oluþmamýþtýr. "
End If
Sheets("Rotalama").Select
